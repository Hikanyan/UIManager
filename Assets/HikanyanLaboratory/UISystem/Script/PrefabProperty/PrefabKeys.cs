...
public static class PrefabKeys
{
    private static readonly Dictionary<string, string> PrefabPathDictionary = new Dictionary<string, string>()
    {
        ...
        { NekoScreen, "Assets/HikanyanLaboratory/UIToolSystem/MVPStateGenerator/Generated/NekoScreen/Resources/NekoScreen.prefab" },
        ...
        { TestWindow, "Assets/HikanyanLaboratory/UIToolSystem/MVPStateGenerator/Generated/TestWindow/Resources/TestWindow.prefab" },
    ...
    public const string NekoScreen = "NekoScreen";
